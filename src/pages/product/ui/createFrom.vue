...
<template>
  ...
  >
    ...
    <n-form-item class="mt-5" :label="$t(`productPage.form.photo`)" path="image">
      <ImageUploader
          :max-count="6"
          v-model="store.payload.images"
      />
      <n-input
          class="!hidden"
          type="text"
    ...
    <n-form-item :label="$t(`productPage.form.name`)" path="name">
      <n-input
          type="text"
          :placeholder="$t(`categoryPage.form.name`)"
    ...
    <n-form-item :label="$t(`categoryPage.form.category`)" path="category">
      <n-select
          ...
          :options="componentStore.categoryList"
          label-field="name"
          value-field="id"
          :loading="componentStore.categoryLoading"
      />
    </n-form-item>
